...
app = Flask(__name__)
app.secret_key = "iyblog"

app.config["MYSQL_HOST"] ="localhost"
app.config["MYSQL_USER"] ="root"
app.config["MYSQL_PASSWORD"] =""
app.config["MYSQL_DB"] ="iyblogg"
...
def register():
    ...
    if request.method == "POST" and form.validate():
        ...
        return render_template("register.html",form = form,methods = ["GET","POST"])
...
def update(id):
    if request.method == "GET":
        ...
        sorgu = "Select * from articles where id = %s and auther = %s"
